            ...
            <div class='mt-5'>
                <div class='title navbar align-item-center row'>
                    <div class='song_img col-4' style="height: 232px; width:232px">
                        <img id="img" src="<?= $currentSong['img'] ?>" alt="">
                    </div>
                    <div class='col-6 grid-container' style='grid-gap: 0px'>
                        <div>Bài hát.</div>
                        <h1 id='songName'><?= $currentSong['songName'] ?></h1>
                        <div class="d-inline">
                            <div id="artist" class="d-inline"><?= $artist ?></div>
                ...
                <div class=''>
                    ...
                    <h3 class='mt-3'>Lời bài hát</h3>

                    <div id='lyric' class=''>
                        <?= $currentSong['lyrics'] ?>
                    </div>

                    <div class="nav-tabs my-5" style="border-color: blueviolet;"></div>
                    <div class='mt-3'>
                        <div>
                            <p>Những bài hát của</p>
                            <strong>
                                <h2><?= $artist ?></h2>
                            </strong>
                        </div>
